...
void main (void)
{
	...
	if(posy <= glowness+6)
    {
        ...
        glowcolor = mix( glowcolor*(2,0.8,0,1) , glowcolor , (posy-glowness)/6.0 );
        if(posy < glowness+3) glowcolor = mix( glowcolor*vec4(2,0.4,0,1) , glowcolor , (posy-glowness)/3.0 );
